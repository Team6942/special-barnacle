...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    private boolean debugAlignment = true;
    public boolean debugContours  = true;
    public boolean stretch        = true;
    public double minArea = 1000;
    private double alignPosOffset = 0;
    private double alignSize = 100;
    ...
    private RatioScorer      ratioScorer        = new RatioScorer(1.0, 3);
    private MaxAreaScorer    maxAreaScorer      = new MaxAreaScorer( 0.01);
    private PerfectAreaScorer perfectAreaScorer = new PerfectAreaScorer(5000,0.05);
